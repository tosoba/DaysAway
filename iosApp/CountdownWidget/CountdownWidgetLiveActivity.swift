...
private extension CountdownWidgetAttributes {
    static var preview: CountdownWidgetAttributes {
        CountdownWidgetAttributes(name: "World")
    }
}

private extension CountdownWidgetAttributes.ContentState {
    static var smiley: CountdownWidgetAttributes.ContentState {
        CountdownWidgetAttributes.ContentState(emoji: "😀")
    }

    static var starEyes: CountdownWidgetAttributes.ContentState {
        CountdownWidgetAttributes.ContentState(emoji: "🤩")
    }
}
